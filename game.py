...
# UNE SECONDE CLASSE QUI VA REPRESENTER NOTRE JEU
class Game:
    ...
    def __init__(self):
        ...
        # mettre le score à 0
        self.font = pygame.font.Font("assets/my_custom_font.ttf", 30)
        self.score = 0
        self.pressed = {}
    ...
    def game_over(self):
        # remettre le jeu à neuf , retirer les monstres, remetrre le joueur à 100 pts de vie, remettre le jeu en attente
        self.all_monsters = pygame.sprite.Group()
    ...
    def update(self, screen):
        ...
        # verifier direction gauche /droite
